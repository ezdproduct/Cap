...
function mapCourseToProduct(course: any): Product {
  ...
  // --- Image Handling ---
  const DEFAULT_IMAGE = "https://placehold.co/600x400/f1f5f9/475569?text=CAP+English";
...
export async function getPaymentGateways(): Promise<PaymentGateway[]> {
    return [
        { id: 'cod', title: 'Chuyển khoản ngân hàng', description: 'Thanh toán qua ngân hàng', enabled: true }
    ];
}
